...
MuiForm.addValidationRule = (name, callback) => {
    Rules[name] = callback;
};

MuiForm.getValidationRule = name => Rules[name];

MuiForm.hasValidationRule = name => Rules[name] && typeof Rules[name] === 'function';

MuiForm.removeValidationRule = (name) => {
    delete Rules[name];
};
